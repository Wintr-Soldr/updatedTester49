...
import com.example.tester49.databinding.ActivityDropdown2Binding
...
class Dropdown2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dropdown2)

        binding = ActivityDropdown2Binding.inflate(layoutInflater)
        ...
        val myAdapter = MyAdapter(this@Dropdown2, 0, categoryModelArrayList)
    ...
    fun onButtonClick(v: View?) {
        ...
        val selectedValue1: String =
            (textInputLayoutmenu1.editText as AutoCompleteTextView?)!!.text.toString()

        val textInputLayoutmenu2 = findViewById<TextInputLayout>(R.id.menu2)
        val selectedValue2: String =
            (textInputLayoutmenu2.editText as AutoCompleteTextView?)!!.text.toString()
